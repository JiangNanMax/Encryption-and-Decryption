		...
		btn_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(jtextfield1.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "请输入密文!");
					flag=1;
				}
				...
				if(flag==0) {
					...
					for(int i=0;i<str1.length();i++) {
						if((str1.charAt(i)>='A' && str1.charAt(i)<='Z') || (str1.charAt(i)>='a' && str1.charAt(i)<='z') || (judge(str1.charAt(i))==1)) {
							continue;
						}
						else {
					...
					if(flag1==1) {
						JOptionPane.showMessageDialog(null, "密文中只允许有大小写字母和空格!");
					}
					else if(flag2==1) {
						JOptionPane.showMessageDialog(null, "密钥中只允许有大小写字母!");
					}
						...
						decryption_solve de=new decryption_solve(s1,s2);
						de.setVisible(true);
